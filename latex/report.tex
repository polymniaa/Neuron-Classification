...
Polymnia Nicolaou  & M. Y. Coauthor \\
 \\
        My Department & Coauthor Department \\
        Carmel High School & Coauthor Institute \\
        Carmel, IN~~46074 & City, STATE~~zipcode
\end{tabular}}
...
With the goal being to test certain methods and achieve the highest accuracy possible, we adjusted the code to make it more efficient. After receiving the data, we stored the given class of each neuron in a separate variable for future reference. The classifiers we focused on were K-Nearest Neighbors, Decision Tree, Random Forest, Logistic Regression, Support Vector Machine and Ensemble. 
K-Nearest Neighbors assigns the unknown neuron 
